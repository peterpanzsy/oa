    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">         
          ...
          <s:form cssClass="form-horizontal" action="info_edit" enctype="multipart/form-data" method="post" role="form">
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-11">
              <s:textfield name="title" cssClass="form-control" ></s:textfield>
            </div>
          </div>
         ...
         <div class="form-group">
            ...
            <div class="col-sm-11">
                ...
                <s:textarea type="text"  data-edit="inserttext" id="voiceBtn" x-webkit-speech="" style="display: none;"></s:textarea>
              </div>            
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button id="info_submit" type="submit" class="btn btn-primary" style="float:right">更新</button>
            </div>
          </div>
          </s:iterator>
        </s:form>

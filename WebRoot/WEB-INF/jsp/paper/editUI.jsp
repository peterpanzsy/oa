            ...
            <table class="table table-bordered">
              <caption>论文详细信息</caption>
                ...
                <tr>
                  ...
                  <td>
                  	<s:checkboxlist name="type" list="{'国际期刊','国际会议','国内期刊','国内期刊'}" value="#paper.type"></s:checkboxlist>
                  </td>
                </tr>
                <tr>
        		 ...
        		 <tr>
                  ...
                  <td>
                  	<s:radio name="state" list="{'已发表','审核中'}" value="#paper.state"></s:radio>
                  </td>                  
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="juan" value="${paper.juan}" class="form-control" type="text"></td>                  
                </tr>
                <tr>
                  <td width="10%"><strong>期</strong></td>
                  <td><input name="qi" value="${paper.qi}" class="form-control" type="text"></td>                  
                </tr>
                <tr>
                  <td width="10%"><strong>所属项目	：</strong></td>
                  <td><input name="programName" value="${paper.program.name}" placeholder="填入所属项目名称" class="form-control" type="text"></td>                  
                </tr>
                <tr>
                  <td width="10%"><strong>页码</strong></td>
                  <td><input name="pagination" value="${paper.pagination}" class="form-control" type="text"></td>                  
                </tr>
                <tr>
                  <td width="10%"><strong>sci索引号</strong></td>
                  <td><input name="SCIIndex" value="${paper.SCIIndex}" class="form-control" type="text"></td>                  
                </tr>

<tr>
                  <td width="10%"><strong>ei索引号</strong></td>
                  <td><input name="EIIndex" value="${paper.EIIndex}" class="form-control" type="text"></td>                  
                </tr>
                <tr>
                  <td width="10%"><strong>是否国内重要期刊</strong></td>
                  <td>
                  	<s:radio name="homeImportantArticle" list="#{0:'不是',1:'是'}" ></s:radio>
...
<tr>
                  ...
                  <td>
                 	 <s:radio name="homeCoreArtile" list="#{0:'不是',1:'是'}" ></s:radio>
                  	<!--  <input class="form-control" type="text">-->
                  	</td>                  
                </tr>
...
<tr>
                  ...
                  <td><input name="theme" value="${paper.theme}" class="form-control" type="text"></td>                  
                </tr>

<tr>
                  <td width="10%"><strong>摘要</strong></td>
                  <td><textarea name="summary" class="form-control" cols="30" rows="5">
                  	<s:property value="#paper.summary"/>
                  </textarea></td>                  
                </tr>
...
<tr>
                  ...
                  <td><input name="SCIQuote" value="${paper.SCIQuote}" class="form-control" type="text"></td>                  
                </tr>

<tr>
                  <td width="10%"><strong>ei被引次数</strong></td>
                  <td><input name="EIQuote" value="${paper.EIQuote}" class="form-control" type="text"></td>                  
                </tr>
                ...
                <tr>
                  ...
                  <td><input name="description" value="${paper.description}" class="form-control" type="text"></td>                  
                </tr>
      ...
      <div class="modal-body">
          <form class="form-horizontal" role="form">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="填入论文名称" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">所属项目：</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="填入所属项目" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">出版刊物：</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="填入出版刊物" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">收录库：</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="填入收录库" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">备注：</label>
                  <div class="col-sm-6">
                    <input type="text" class="form-control" placeholder="填入备注" >
                  </div>
                </div>

    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">         
          ...
          <s:form cssClass="form-horizontal" action="economy_edit" enctype="multipart/form-data" method="post" role="form">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-11">
              ...
              <div id="editor" contenteditable="true"  >
              	...
              	<!-- 这个是自己加的 -->
              	<s:hidden name="nowcontent" id="eco_content">
              	</s:hidden>
